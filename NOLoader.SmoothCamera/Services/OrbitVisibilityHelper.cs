...

        {
...

            {
                ...
                targetUpShift = ComputeShiftMeters(
                    ...
                    camera, virtualCameraPos, focus, screenH, targetY - sp.y, 1f, steepPitch);

            }

            else if (offTarget && !steepPitch)
            ...
            bool instantApply = OrbitRuntimeFlags.DiagnosticInstantBoresight;
...

            {
...

                {
                    ...
                    state.VisibilityTargetOffset = targetUpShift;

                    state.VisibilityAppliedOffset = targetUpShift;
